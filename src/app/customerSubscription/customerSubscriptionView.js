...
export default function CustomerSubscriptionView() {
    ...
    return (
        <>
            ...
            <div className="modal fade" tabIndex="-1" id="liceseKeyViewModal" role="dialog">
            ...
            <div class="modal" tabIndex="-1" id="product_unsubscribe_selection_message_modal">
                            ...
                            <div class="row g-2">
                                <div class="col-12">
                                    <h3 class="form-label text-center">
                                        <span class="text03" id="unsubscribeselectionMsgDescriptionHead"></span><br />
                                    </h3><br /><br />
                                    <div className="col-12">
