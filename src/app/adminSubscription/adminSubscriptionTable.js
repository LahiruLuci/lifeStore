...
const AdminSubscriptionTableRows = ({ adminSubscriptions, onAdminSubscriptionsClick, onCustomerSubscriptionsUnsubscribeClick }) => {
                    ...
                    <tbody>
                        {adminSubscriptions.map((adminSubscription) => (
                            ...
                            <tr className="subscriptionText border-bottom" key={adminSubscription.SUBSCRIPTIONID}>
                                ...
                                <td className="td2">{(adminSubscription.CREATEDDATETIME).toString().split('T')[0]}</td>
                                <td className="td2">
