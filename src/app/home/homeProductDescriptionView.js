...
export default function HomeProductDescriptionView() {
    ...
    const backToCustomerHome = () =>{
        const customerHomeId = document.getElementById("customerHomeId");
        const customerProductDescriptionHomeId = document.getElementById("customerProductDescriptionHomeId");
        customerHomeId.classList.remove("d-none");
        customerProductDescriptionHomeId.classList.add("d-none");
    }

    return (
        <div className="mb-5">
            <div className="col-12 mt-3 mb-1 p-5 pb-0">
                <span className="title21" onClick={backToCustomerHome}><i class="bi bi-arrow-bar-left fs-1"></i>&nbsp;</span><span className="aboutTitleHead1">KASPERSKY </span><span className="aboutTitleHead2">INTERNET
