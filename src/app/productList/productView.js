...
const Products = ({ products, onProductClick }) => {
    if (!products || !Array.isArray(products) || products.length === 0) {
        ...
        const onSingleProductViewClick2 = useCallback((product) => {
            updateProductView();
            onProductClick(product);
        }, [onProductClick]);
        ...
        return (
            <>
                {products.map((product) => (
                    <div className="productCardView p-2" style={{ maxWidth: "18rem" }} key={product.PRODUCTID}>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-9">
                                        <div className="row">
                                            <div className="col-12">
                                                <div className="row">
                                                <div className="col-10 p-0" style={{height:"50px"}}>
                                                <span className="title07">{product.PRODUCTNAME}</span>
                                                    </div>
                                                    <button className="col-1 editBtn" onClick={() => onSingleProductViewClick2(product)}></button>
                                                </div>
                                            </div>
                                            <div className="col-3">
                                                <div className="row">
